...
if($sandbox_if=='1'){
  ...
  print '<iframe src="https://streamnoads.com/e/x1krvkz3K9U0m4/" width="800" height="600" allowfullscreen allowtransparency allow="autoplay" scrolling="no" frameborder="0"></iframe>';
 }else{
