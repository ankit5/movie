...
// echo "</pre>";
  ...
  if(isset($pieces[1][1])) {
    ...
    //  print $obj->first;
    // exit;
     $download_link .= '<a href="https://m3u8downloader.hdmovies2.online/?name='.$node->title->value.'&qt='.findResolution($pieces[0][0]).'&source='.$pieces[1][1].'" target="_blank" class="lnk-lnk lnk-1"> 
