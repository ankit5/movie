 ...
 * @endcode
 */
$settings['hash_salt'] = 'WR1XNNutugM7zdifIqDidrT4b9EzYkiqfFkDOU_tOoCf7bBClRMLovJJVrmiq-CDIdHaYLzvwg';
 ...
 * change events.
 */
 $config['system.site']['name'] = 'multimovies';
 $config['user.settings']['anonymous'] = 'Visitor';
 $config['system.theme']['default'] = 'multimovies';
...
$settings['config_sync_directory'] = 'sites/multimovies.club/files/config_wvvFtcl5_23W0SJYYDcGbJiWSqzKbnLGfYo41Ez94aZND0-HFTDSDnyGTPRE3H5HXHONHJ3W5Q/sync';
